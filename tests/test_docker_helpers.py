...
2. compose_file 不存在 → DockerError 文案含引导：``newsbox setup``
...
from newsbox.commands import docker_helpers
from newsbox.commands.docker_helpers import DockerError, _run_compose
